...
class LocationServiceImplTest {
    ...
    void getLocationById() {
        Mockito.when(locationDao.findById(this.location1.getId())).thenReturn(Optional.ofNullable(this.location1));
    ...
    void getLocationByIdThrowResourceNotFoundException () {
        Mockito.when(locationDao.findById(this.location1.getId())).thenReturn(Optional.empty());
