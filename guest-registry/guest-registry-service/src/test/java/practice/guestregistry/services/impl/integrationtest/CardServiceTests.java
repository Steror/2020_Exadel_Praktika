...
@SpringBootTest(classes = {CardServiceImpl.class, LocationServiceImpl.class,
                            ...
                            CardMapper.class, LocationMapper.class, EmbeddedMongoConfig.class})
...
//        cardService.getCardById(card.getId());
    ...
    public void existCardContainingIdSerial() {
        cardService.addCard(card);
        assertThat(cardService.existCardContainingIdSerial(card.getId(), card.getSerialNumber())).isEqualTo(true);
    }

    @Test
    public void existCardContainingIdSerial_incorrectData() {
        assertThat(cardService.existCardContainingIdSerial(card.getId(), card.getSerialNumber())).isEqualTo(false);
    }
